...
const columns = [
    ...
    { field: 'nombre_producto', headerName: 'Producto', width: 100 },
    { field: 'valor_producto', headerName: 'Valor Producto', width: 150 },
...
function InformesCobros() {
    ...
    const fetchData = async (mes, year) => {
        try {
            const response = await axios.get(`http://localhost:4321/informesCobros/${user.id}?mes=${mes}&anio=${year}`);
